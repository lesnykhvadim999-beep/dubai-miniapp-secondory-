...
def admin_notify(text: str,
    ...
    Args:
      priority: "critical" (always send), "normal" (send unless ADMIN_NOTIFY_QUIET=1),
                "info" (skip if ADMIN_NOTIFY_QUIET=1)
    ...
    """
    quiet = os.environ.get("ADMIN_NOTIFY_QUIET", "0") == "1"
    if quiet and priority == "info":
        return False
