"""DB helper for pattern_mining (RESALE_DATABASE_URL or DATABASE_URL)."""
...
def get_dsn() -> str:
    ...
    if not dsn:
        raise RuntimeError(
            "No DB DSN: set RESALE_DATABASE_URL / DATABASE_URL / RESALE_DATABASE_URL_PUBLIC"
        )
    return dsn
...
def ensure_schema() -> None:
    """Idempotently apply migrations.sql."""
